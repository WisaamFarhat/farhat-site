...
def FOOTER():
  ...
  <div><h4>The Digest</h4>
    <a href="/ific/">All issues</a><a href="/ific/schedule/">2026 schedule</a><a href="/ific/" data-l-foot>Latest issue</a></div>
  <div><h4>Reference</h4>
...
urls=[("/",1.0),("/ific/",0.9),("/services/",0.9),("/ific/schedule/",0.85)]+[(f"/ific/{n}/",0.8) for n in sorted(DATA,reverse=True)]
